...
AS $$
DECLARE
  project_url TEXT := 'https://msdomrdbyvlrddjsjshp.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1zZG9tcmRieXZscmRkanNqc2hwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxOTEwMTkzNCwiZXhwIjoyMDM0Njc3OTM0fQ.QkyBaB9MiCbSe7BHc5YbRWju-qWfw71ul02dJSllITw';
